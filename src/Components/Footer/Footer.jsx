        ...
        <footer id='footer' className='text-white' style={{ backgroundColor: '#123F1E' }}>
            ...
            <div>
                ...
                <div className='text-center flex items-center h-12'>
                    <span className='text-xs  w-full block text-gray-300 tracking-wider'>© 2024 Developed By <a className='hover:underline' href="https://github.com/Prijwal-123" target="_blank" rel="noopener noreferrer"> PRIJWAL </a></span>
                </div>
            </div>
        </footer>
    );
